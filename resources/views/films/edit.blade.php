...
{{--            </div>--}}
            ...
            <div class="col-12">
                ...
                <textarea class="form-control" name="about" id="about" rows="20">{{ old('name', $film->about) }}</textarea>
            </div>
            <div class="col-12">
                <label for="content" class="form-label">Краткий пересказ сюжета</label>
                <textarea class="form-control" name="content" id="content" rows="20">{{ old('name', $film->content) }}</textarea>
            </div>
            <div class="col-12">
